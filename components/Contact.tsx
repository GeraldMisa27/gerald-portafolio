          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`bg-[#13131e] border rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-white/20 outline-none transition-colors ${
                    errors.name
                      ? "border-[#f87171]"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                rows={4}
                className={`bg-[#13131e] border rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-white/20 outline-none transition-colors resize-none ${
                  errors.message
                    ? "border-[#f87171]"
                    : "border-white/10 focus:border-[#6366f1]"
                }`}
            ...
            {result && (
              <p className={`text-sm ${
                result.type === "success" ? "text-[#4ade80]" : "text-[#f87171]"
              }`}>
                {result.text}
              </p>
            )}
